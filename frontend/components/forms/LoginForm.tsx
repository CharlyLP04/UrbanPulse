    ...
    return (
      <div className="p-6 sm:p-8 bg-white flex flex-col justify-center h-full">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-500">Ingresa el código que enviamos a tu correo</p>
        </div>
        ...
        <form className="flex flex-col gap-4" onSubmit={onVerify} noValidate>
          <div className="flex flex-col gap-1.5">
            <label htmlFor="code" className="text-xs font-bold text-gray-700">Código de 6 dígitos</label>
            <input
              id="code"
              type="text"
              required
              ...
              className="w-full px-3 py-3 text-center text-xl font-bold tracking-[0.5em] border-2 rounded-lg outline-none transition-colors border-gray-200 focus:border-sky-500 focus-visible:ring-4 focus-visible:ring-sky-500/30"
              placeholder="------"
            />
          </div>

          <button type="submit" className="w-full mt-4 bg-[#3282b8] hover:bg-[#0f4c75] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#3282b8]/50 active:transform active:scale-[0.98] text-white font-bold py-3 rounded-lg text-sm shadow-md transition-all">
            Verificar y Entrar
          </button>
        </form>
      </div>
